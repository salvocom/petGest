...
class HTMLClienti extends HTML
{
	...
	///
	//////////////////////////////////////////////////////////////////	
	function drawClientiForm($container,$columns,$result=null)
	{
		$div = $this->getElementById($container);
		$h3 = $div->appendChild(new DOMElement('h3'));
		$h3->appendChild($this->htmlDom->createTextNode('Clienti'));
		...
		$td = $tr->appendChild(new DOMElement('td'));
		$p = $td->appendChild(new DOMElement('p'));
		$p->appendChild($this->htmlDom->createTextNode($columns['comune_di_nascita']['layout']));
		$td = $tr->appendChild(new DOMElement('td'));
		$input = $td->appendChild(new DOMElement('input'));
		$input->setAttribute('type','text');
		$input->setAttribute('id',$columns['comune_di_nascita']['name']);
		$input->setAttribute('name',$columns['comune_di_nascita']['name']);
		$input->setAttribute('size',$columns['comune_di_nascita']['size']+3);
		$input->setAttribute('maxlength',$columns['comune_di_nascita']['size']);
		if($modify)
			$input->setAttribute('value',$result['comune_di_nascita']);
		
		$td = $tr->appendChild(new DOMElement('td'));
		$p = $td->appendChild(new DOMElement('p'));
		$p->appendChild($this->htmlDom->createTextNode($columns['provincia_di_nascita']['layout']));
		$td = $tr->appendChild(new DOMElement('td'));
		$input = $td->appendChild(new DOMElement('input'));
		$input->setAttribute('type','text');
		$input->setAttribute('id',$columns['provincia_di_nascita']['name']);
		$input->setAttribute('name',$columns['provincia_di_nascita']['name']);
		$input->setAttribute('size',$columns['provincia_di_nascita']['size']+3);
		$input->setAttribute('maxlength',$columns['provincia_di_nascita']['size']);
		if($modify)
			$input->setAttribute('value',$result['provincia_di_nascita']);
		...
		$td = $tr->appendChild(new DOMElement('td'));
		$p = $td->appendChild(new DOMElement('p'));
		$p->appendChild($this->htmlDom->createTextNode($columns['telefono_3']['layout']));
		$td = $tr->appendChild(new DOMElement('td'));
		$input = $td->appendChild(new DOMElement('input'));
		$input->setAttribute('type','text');
		$input->setAttribute('id',$columns['telefono_3']['name']);
		$input->setAttribute('name',$columns['telefono_3']['name']);
		$input->setAttribute('size',$columns['telefono_3']['size']+3);
		$input->setAttribute('maxlength',$columns['telefono_3']['size']);
		if($modify)
			$input->setAttribute('value',$result['telefono_3']);
